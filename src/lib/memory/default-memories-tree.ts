...
type MdFileOptions = {
    /** Include `status: ""` in frontmatter — for areas/topics files where the AI tracks active/paused/dormant/done. Omitted for fixed you/ singletons and sessions/. */
    withStatus?: boolean
}
